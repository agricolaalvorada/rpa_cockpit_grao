...
-- CFIN: VIA_MIRO removido — GJAHR do MIRO de complemento não bate com J_1BNFDOC.
-- Único caminho válido para VALOR: CPF + QTDE com âncora de data (sem filtro de valor).
SELECT
